...
pub fn find_elf_symbol(elf_file: &elf::ElfBytes<elf::endian::AnyEndian>, name: &str) -> Option<usize> {
...
pub fn find_elf_symbol_dyn(elf_file: &elf::ElfBytes<elf::endian::AnyEndian>, name: &str) -> Option<usize> {
...
pub fn va_to_file_offset(elf_file: &elf::ElfBytes<elf::endian::AnyEndian>, va: usize) -> Option<usize> {
