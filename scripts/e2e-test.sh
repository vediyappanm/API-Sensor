...
SENSOR_BIN="${SENSOR_BIN:-/home/admin/sensor/API-Sensor/userspace/target/release/api-sec-sensor}"
BPF_OBJ="${BPF_OBJ:-/home/admin/sensor/API-Sensor/bpf/http_trace.bpf.o}"
INGEST_PORT=9999
METRICS_PORT=9091
INGEST_PID=""
SENSOR_PID=""
